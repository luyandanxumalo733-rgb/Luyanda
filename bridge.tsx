        ...
        <div className="mx-auto max-w-md px-4 pb-24 pt-6">
          ...
          <section className="mt-5 rounded-2xl border border-white/10 bg-[oklch(0.18_0.06_260_/_0.7)] p-4">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
                      Install a free Webhook Receiver EA on your MT5 terminal (or a remote Windows VPS). Copy your terminal's public <b className="text-foreground">IP Address</b> and secure <b classNa[...]
 </p>
  110  <a
   ...
   <span className="font-mono text-[11px]">{status?.region ?? "-"}</span>
            ...
            <div className="mt-3 grid grid-cols-2 gap-2">
              <button
                onClick={refresh}
                disabled={loading}
                className="inline-flex items-center justify-center gap-1.5 rounded-xl border border-white/15 bg-white/5 px-3 py-2 text-[11px] font-semibold uppercase tracking-widest hover:bg-white/10 [...]
              >
